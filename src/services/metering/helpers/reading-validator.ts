...
import { CreateReadingSessionInternal } from '../types/index.js';
...
export const _validateDuplicateSession = async (
  ...
  if (existingSession) {
    ...
    const existingTypes = existingSession.details
...
export const _validateMeter = async (
  meter_id: number
): Promise<MeterWithRelations> => {
